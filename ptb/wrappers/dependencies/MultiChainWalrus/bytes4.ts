...
export class Bytes4 implements StructClass {
    $type: string = `${do_get_package_address()}::${MODULE_NAME}::Bytes4`;
    ...
    from_bcs(arg: any) {
        return Bytes4.from_bcs(arg)
    }

    from_bcs_vector(args: any) {
        return Bytes4.from_bcs_vector(args)
    }
    ...
    static $type() {
        return `${do_get_package_address()}::${MODULE_NAME}::Bytes4`
    }
    ...
    static get bcs() {
        return bcs_import.struct("Bytes4", {
            data: bcs_import.vector(bcs_import.u8()),
        }).transform({
            input: (val: any) => {
                return val
            },
            output: (val) => new Bytes4(val.data),
        });
    };
}
...
export function data(tx: Transaction, arg0: Bytes4 | TransactionArgument) {
    let args: any[] = [
        isTransactionArgument(arg0) ? arg0 : tx.pure(Bytes4.bcs.serialize((arg0 as Bytes4)))
    ]
...
export function to_bytes(tx: Transaction, arg0: Bytes4 | TransactionArgument) {
    let args: any[] = [
        isTransactionArgument(arg0) ? arg0 : tx.pure(Bytes4.bcs.serialize((arg0 as Bytes4)))
    ]
...
export function is_nonzero(tx: Transaction, arg0: Bytes4 | TransactionArgument) {
    let args: any[] = [
        isTransactionArgument(arg0) ? arg0 : tx.pure(Bytes4.bcs.serialize((arg0 as Bytes4)))
    ]
...
export function pad_right(tx: Transaction, arg0: number[] | TransactionArgument, arg1: boolean | TransactionArgument) {
    let args: any[] = [
    ...
    return tx.moveCall({
        target: `${do_get_package_address()}::${MODULE_NAME}::pad_right`,
        arguments: args,
    })
}
