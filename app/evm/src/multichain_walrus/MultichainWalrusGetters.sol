...
import "./MultichainWalrusSetters.sol";

contract MultichainWalrusGetters is MultichainWalrusSetters {
    ...
    function getReceivedMessage(bytes32 hash) public view returns (bytes memory) {
